              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@techtrove.com" className="text-primary-600 hover:underline">info@techtrove.com</a>
                    <p className="text-gray-600 mt-2 mb-1">For customer support:</p>
                    <a href="mailto:support@techtrove.com" className="text-primary-600 hover:underline">support@techtrove.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+18001234567" className="text-primary-600 hover:underline">+1 (800) 123-4567</a>
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                We offer a 30-day return policy for most items. Products must be in original condition with all packaging. Some items like earbuds may have specific hygiene-related restrictions.
              </p>
            </div>
